...
<head>
    ...
    <style>
        ...
        tbody tr:nth-child(odd) {
            background-color: #dcdddc; /* Warna baris ganjil */
        }
                ...
                <tr>
                    ...
                    @foreach ($buses as $bus)
                        <td class="combined-data">
                            @php
                                // Format tanggal untuk baris ini
                                $date = date('Y-m-d', mktime(0, 0, 0, date('m'), $row, date('Y')));
                                ...
                                if ($jadwal && $jadwal->bus === $bus) {
                                    ...
                                    $data .= "Driver : " . (isset($jadwal->crew1) ? e($jadwal->crew1->nama) : 'N/A') . "\n";
                                    $data .= "Co Driver : " . (isset($jadwal->crew2) ? e($jadwal->crew2->nama) : 'N/A') . "\n";
